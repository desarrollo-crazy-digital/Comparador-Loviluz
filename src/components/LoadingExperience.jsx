      ...
      <div className="loading-stage w-full max-w-2xl text-center">
        <div className="relative inline-flex items-center justify-center">
          ...
          <img
            src="/LogoLoviluz.svg"
            alt="Loviluz"
            className="h-20 md:h-24 w-auto object-contain loading-loviluz-logo relative z-10"
          />
        </div>

        <div className="mt-6">
          <div className="text-[11px] font-black uppercase tracking-[0.24em] text-blue-700/75">Loviluz</div>
